define([''], function(){
	//游戏运行
	 ...
	 function gameInit(o) {
	     ...
	     //还原首个食物位置
	     // var foodOrigin = o.box.children[1];
	     ...
	     for (var i = o.box.children.length - 1; i > 1; i--) {
	 ...
	 function foodRandom(o) {
	     var leftRand = parseInt(Math.random() * (o.box.offsetWidth / o.snake.width)) * o.snake.width;
	     var topRand = parseInt(Math.random() * (o.box.offsetHeight / o.snake.width)) * o.snake.width;
	     var newFood = o.foodInit.cloneNode();
